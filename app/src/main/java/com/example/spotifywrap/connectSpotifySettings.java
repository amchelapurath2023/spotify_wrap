...
public class connectSpotifySettings extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.settings_connect_spotify);
    ...
    public void getToken() {
        ...
        AuthorizationClient.openLoginActivity(connectSpotifySettings.this, AUTH_TOKEN_REQUEST_CODE, request);
    }
